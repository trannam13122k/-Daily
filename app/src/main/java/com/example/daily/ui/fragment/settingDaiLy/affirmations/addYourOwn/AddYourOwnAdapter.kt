...
class AddYourOwnAdapter(private var list: List<AddModel>?) :
    RecyclerView.Adapter<AddYourOwnAdapter.CollectionsViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AddYourOwnAdapter.CollectionsViewHolder {
