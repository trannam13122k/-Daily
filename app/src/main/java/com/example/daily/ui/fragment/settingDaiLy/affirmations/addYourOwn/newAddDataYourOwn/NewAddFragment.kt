...
class NewAddFragment : BaseFragment<FragmentNewAddBinding>() {
    ...
    override fun init() {
        ...
        addModel = arguments?.getParcelable(KeyWord.addModel)
    ...
    private fun setUpListener() {
        ...
        binding.btnSave.setOnClickListener {
            if (addModel != null) handleBtnEdit(addModel!!) else handleBtnSave()
        }
    }
    ...
    private fun handleBtnEdit(addModel: AddModel) {
        ...
        if (text.isEmpty()) {
            ...
            val editContent = AddModel(
                id = addModel.id,
                nameAdd = text,
                nameCollection = addModel.nameCollection,
                isFavourite = false,
                day = addModel.day
            )
