...
class CollectionsAdapter  (private var listCollections : List<CollectionModel>?): RecyclerView.Adapter<CollectionsAdapter.CollectionsViewHolder>(){
    ...
    inner class CollectionsViewHolder(val binding: ItemCollectionsBinding): RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CollectionsAdapter.CollectionsViewHolder {
        val view= ItemCollectionsBinding.inflate(LayoutInflater.from(parent.context), parent,false)
