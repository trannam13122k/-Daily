...
object DataB {
    ...
    val listFont: List<ItemPickerModel> = listOf(
        ...
        ItemPickerModel("", R.font.caveat_brush_regular, R.drawable.caveatbrush, "Font", 0, 0, 0,""),
    ...
    var listAligment: List<ItemPickerModel> = listOf(
        ...
        ItemPickerModel("#4BD392", 0, R.drawable.aligmentcenter, "Color", 0,Gravity.NO_GRAVITY,0,""),
    ...
    var listAligmentTop: List<ItemPickerModel> = listOf(
        ...
        ItemPickerModel("#5369EC", 0, R.drawable.aligncenter, "Color", 0, 0, Gravity.NO_GRAVITY,""),
